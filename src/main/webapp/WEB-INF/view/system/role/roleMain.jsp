...
<div class="childrenBody">
    <div style="padding:10px 20px 1px 20px;">
        ...
        <form class="layui-form" method="post" id="searchRole">
        ...
        <div id="roleBar" style="display: none">
            ...
            <a class="layui-btn layui-btn-normal layui-btn-sm" lay-event="assignMenu">分配角色</a>
...
<script type="text/javascript">
    ...
    layui.extend({
        ...
        table.on('toolbar(roleTable)', function(obj){
            switch(obj.event){
                ...
                case 'getSelect':   //获取checkbox选中行的数据
                    var checkStatus = table.checkStatus('roleTable'); //roleTable:数据表格的ID
        ...
        $("#doSearch").click(function () {
            var params = $("#searchRole").serialize();
            console.log(params);
            tableIns.reload({
        ...
        // 回调函数返回一个object参数 roleTable:数据表格的ID
...
//监听行双击事件
        ...
        //监听工具条  注：tool 是工具条事件名，roleTable 是 table 原始容器的属性 lay-filter="对应的值"
