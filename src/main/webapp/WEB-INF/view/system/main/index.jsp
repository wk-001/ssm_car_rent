...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>layuicms2.0/css/index.css" media="all" />
    <script type="text/javascript" src="<%=basePath%>layuicms2.0/layui/layui.js"></script>
    <script type="text/javascript" src="<%=basePath%>layuicms2.0/js/cache.js"></script>
    <script type="text/javascript" src="<%=basePath%>layuicms2.0/js/index.js"></script>
</head>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo">汽车出租系统</a>
            <!-- 显示/隐藏菜单 -->
            <a href="javascript:;" class="seraph hideMenu icon-caidan"></a>
            <ul class="layui-nav topLevelMenus" pc>
                <li class="layui-nav-item layui-this" data-menu="carRent">
                    <a href="javascript:;"><i class="layui-icon" data-icon="&#xe657;">&#xe657;</i><cite>汽车出租</cite></a>
                </li>
